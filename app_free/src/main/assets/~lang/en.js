var lang_en = {
    ...
    Welcome: "Hi, welcome to 'click to vote' APP",
    rules: "1. Click again on the <b>'click-to-vote'</b> link to load votes<br/>"
            + "2. Make your <b>vote</b> <br/>"
            + "3. <b>Share</b> an updated image to <b>anybody</b>!",
    MakeNew: "New Poll",
    Create: "Create",
    ...
    multipleChoice: "Allows multiple choice votation.",
    ...
    ,
    //~vote placeholders
    QuestionPlaceholder: "Write the question and extra information on next line",
    ...
    AllowAppServices: "Please, <b>improve</b> your user experience allowing <b>'usage access'</b>.<br/> "
            + "Then, click again on the 'click-to-vote' link.",
    ...
    more: "more",
    min1Option: "put al least 1 option",
    ...
    votationRemoved: "sorry, this votation seems removed",
    ...
    ownerNameExample: "this is the owner name",
    ...
    e_votationWithErrors: "sorry, this votation have errors. Please contact us.",
